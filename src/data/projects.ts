...
export const projects: Project[] = [
  {
    ...
    repository: 'https://github.com/ralphcristofer/mtllocalestore',
    featured: true,
  },
  {
    name: 'SKAP',
    eyebrow: 'Stateful event software',
    problem:
  ...
  {
    name: 'PhotoHub',
    eyebrow: 'Camera and media workflow',
    problem:
    ...
    status: 'Active development',
    repository: 'https://github.com/ralphcristofer/PhotoHub',
    featured: true,
  },
]
...
export const additionalProjects = [
  {
    ...
    repository: 'https://github.com/ralphcristofer/prompter',
  },
  {
    ...
    repository: 'https://github.com/ralphcristofer/retro-deck-hub-updater',
  },
  {
    name: 'WizStack',
    description: 'A collaborative MERN student-management system for organizing courses and tracking assessments.',
    repository: 'https://github.com/ralphcristofer/WizStack',
  },
  {
    ...
    repository: 'https://github.com/ralphcristofer/Oracle-SQL-Library-Management',
  },
]
